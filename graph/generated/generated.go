...
type ComplexityRoot struct {
	...
	Mutation struct {
		...
		Signup func(childComplexity int, name string, email string, password string, embedding []float64) int
	}

	Query struct {
		SearchUsersByVector func(childComplexity int, vector []float64, topK int) int
...
type MutationResolver interface {
	Signup(ctx context.Context, name string, email string, password string, embedding []float64) (*model.User, error)
	Signin(ctx context.Context, email string, password string) (*model.AuthPayload, error)
}
type QueryResolver interface {
	Users(ctx context.Context) ([]*model.User, error)
	SearchUsersByVector(ctx context.Context, vector []float64, topK int) ([]*model.User, error)
}
type UserResolver interface {
	Embedding(ctx context.Context, obj *model.User) ([]float64, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.signup":
		...
		return e.complexity.Mutation.Signup(childComplexity, args["name"].(string), args["email"].(string), args["password"].(string), args["embedding"].([]float64)), true

	case "Query.searchUsersByVector":
		if e.complexity.Query.SearchUsersByVector == nil {
			break
		}

		args, err := ec.field_Query_searchUsersByVector_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.SearchUsersByVector(childComplexity, args["vector"].([]float64), args["topK"].(int)), true
	...
	case "User.embedding":
		if e.complexity.User.Embedding == nil {
			break
		}

		return e.complexity.User.Embedding(childComplexity), true
...
type Query {
  users: [User!]!
  searchUsersByVector(vector: [Float!]!, topK: Int!): [User!]!
}

type Mutation {
  signup(name: String!, email: String!, password: String!, embedding: [Float!]!): User!
...
func (ec *executionContext) field_Mutation_signup_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	args["password"] = arg2
	arg3, err := ec.field_Mutation_signup_argsEmbedding(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["embedding"] = arg3
...
func (ec *executionContext) field_Mutation_signup_argsEmbedding(
	ctx context.Context,
	rawArgs map[string]any,
) ([]float64, error) {
	if _, ok := rawArgs["embedding"]; !ok {
		var zeroVal []float64
		return zeroVal, nil
	}

	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("embedding"))
	if tmp, ok := rawArgs["embedding"]; ok {
		return ec.unmarshalNFloat2ᚕfloat64ᚄ(ctx, tmp)
	}
...
func (ec *executionContext) field_Query_searchUsersByVector_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Query_searchUsersByVector_argsVector(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["vector"] = arg0
	arg1, err := ec.field_Query_searchUsersByVector_argsTopK(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["topK"] = arg1
...
func (ec *executionContext) field_Query_searchUsersByVector_argsVector(
	ctx context.Context,
	rawArgs map[string]any,
) ([]float64, error) {
...
func (ec *executionContext) field_Query_searchUsersByVector_argsTopK(
	ctx context.Context,
	rawArgs map[string]any,
) (int, error) {
	if _, ok := rawArgs["topK"]; !ok {
		var zeroVal int
		return zeroVal, nil
	}

	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("topK"))
	if tmp, ok := rawArgs["topK"]; ok {
...
func (ec *executionContext) fieldContext_AuthPayload_user(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "embedding":
				return ec.fieldContext_User_embedding(ctx, field)
			}
...
func (ec *executionContext) _Mutation_signup(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().Signup(rctx, fc.Args["name"].(string), fc.Args["email"].(string), fc.Args["password"].(string), fc.Args["embedding"].([]float64))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_signin(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNAuthPayload2ᚖtestᚋgraphᚋmodelᚐAuthPayload(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_searchUsersByVector(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_searchUsersByVector(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().SearchUsersByVector(rctx, fc.Args["vector"].([]float64), fc.Args["topK"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Query_searchUsersByVector(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_searchUsersByVector_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _User_embedding(ctx context.Context, field graphql.CollectedField, obj *model.User) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_User_embedding(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.User().Embedding(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_User_embedding(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "User",
		Field:      field,
		IsMethod:   true,
	...
	for i, field := range fields {
		...
		case "searchUsersByVector":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_searchUsersByVector(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
	...
	for i, field := range fields {
		...
		case "embedding":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._User_embedding(ctx, field, obj)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
...
func (ec *executionContext) marshalNAuthPayload2testᚋgraphᚋmodelᚐAuthPayload(ctx context.Context, sel ast.SelectionSet, v model.AuthPayload) graphql.Marshaler {
	return ec._AuthPayload(ctx, sel, &v)
}

func (ec *executionContext) marshalNAuthPayload2ᚖtestᚋgraphᚋmodelᚐAuthPayload(ctx context.Context, sel ast.SelectionSet, v *model.AuthPayload) graphql.Marshaler {
	if v == nil {
